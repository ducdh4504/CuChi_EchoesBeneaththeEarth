...
//        AudioClip targetClip = ChooseClip(groundHit, isRunning);
...
//    private AudioClip ChooseClip(RaycastHit groundHit, bool isRunning)
//    {
...
//    private void PlayLoop(AudioClip targetClip, bool isRunning)
//    {
...
//            footstepSource.loop = true;
//            footstepSource.volume = footstepVolume;
//            footstepSource.pitch = isRunning ? 1.05f : 1f;
//            footstepSource.Play();

//            if (debugLogs)
//            {
//                Debug.Log($"Footstep loop started: {currentClip.name}");
//            }
...
//        if (debugLogs)
//        {
//            Debug.Log("Footstep loop stopped.");
//        }
//    }
//}
